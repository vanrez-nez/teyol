...
const validatorCache = new WeakMap<object, ReturnType<typeof TypeCompiler.Compile>>();
...
function getSubSchemaValidator(schema: JsonSchemaObject): ReturnType<typeof TypeCompiler.Compile> | undefined {
...
function getValidator(schema: Tool["parameters"]): ReturnType<typeof TypeCompiler.Compile> {

...
import { loadThemeFromPath, type Theme } from "#llm-agent/modes/interactive/theme/theme.js";
...
import { createExtensionRuntime, loadExtensionFromFactory, loadExtensions } from "#llm-agent/core/extensions/loader.js";
import type { Extension, ExtensionFactory, ExtensionRuntime, LoadExtensionsResult } from "#llm-agent/core/extensions/types.js";
...
function loadContextFileFromDir(dir: string): { path: string; content: string } | null {
	const candidates = ["AI.md", "AI.MD", "ASSISTANT.md", "ASSISTANT.MD", "AGENTS.md", "AGENTS.MD", "CLAUDE.md", "CLAUDE.MD"];

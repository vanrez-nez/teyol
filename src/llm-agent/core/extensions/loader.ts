...
import { createEventBus, type EventBus } from "#llm-agent/core/event-bus.js";
import { getLogger } from "#llm-agent/core/logger.js";
import type { ExecOptions } from "#llm-agent/core/exec.js";
import { execCommand } from "#llm-agent/core/exec.js";
import { createSyntheticSourceInfo } from "#llm-agent/core/source-info.js";
import type {
	Extension,
	ExtensionAPI,
	ExtensionFactory,
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"typebox/compiler": _bundledTypeboxCompile,
...
function getAliases(): Record<string, string> {
	...
	_aliases = {
		...
		"@sinclair/typebox/compiler": typeboxCompileEntry,

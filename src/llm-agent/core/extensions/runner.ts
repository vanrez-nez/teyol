...
import type { ResourceDiagnostic } from "#llm-agent/core/diagnostics.js";
import type { KeybindingsConfig } from "#llm-agent/core/keybindings.js";
import type { ModelRegistry } from "#llm-agent/core/model-registry.js";
import type { SessionManager } from "#llm-agent/core/session-manager.js";
import type {
...
// Dummy theme until we have a real one
const theme = {} as any;

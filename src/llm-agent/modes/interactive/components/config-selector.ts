...
import type { PathMetadata, ResolvedPaths, ResolvedResource } from "#llm-agent/core/package-manager.js";
import type { PackageSource, SettingsManager } from "#llm-agent/core/settings-manager.js";

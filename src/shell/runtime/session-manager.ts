...
export class MissingSessionCwdError extends Error {
	constructor(public readonly cwd: string) {
		super(`Session directory does not exist: ${cwd}`);
		this.name = "MissingSessionCwdError";
	}
}

export function formatMissingSessionCwdPrompt(cwd: string): string {
	return `The session's working directory no longer exists:\n  ${cwd}\n\nWould you like to resume in the current directory instead?`;
}

export function assertSessionCwdExists(session: SessionManager, defaultCwd: string): void {
	const cwd = session.getCwd() || defaultCwd;
	if (!existsSync(resolve(cwd))) {
		throw new MissingSessionCwdError(cwd);
	}
}
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, undefined/false if generated by Teyol */
	fromHook?: boolean;
}
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, false if generated by Teyol */
	fromHook?: boolean;
}
 ...
 * Encodes cwd into a safe directory name under ~/.teyol/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.teyol/agent/sessions/<encoded-cwd>/).
	 */

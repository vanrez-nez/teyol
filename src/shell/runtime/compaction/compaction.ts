...
function extractFileOperations(
	...
	// Collect from previous compaction's details (if Teyol-generated)
...
/**
 * Find valid cut points: indices of user, assistant, custom, or  messages.
 * Never cut at tool results (they must follow their tool call).
 * When we cut at an assistant message with tool calls, its tool results follow it
 * and will be kept.
 *  is treated like a user message (user-initiated context).
 */
...
/**
 * Find the user message (or ) that starts the turn containing the given entry index.
 * Returns -1 if no turn start found before the index.
 *  is treated like a user message for turn boundaries.
 */
